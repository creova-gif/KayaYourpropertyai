...
export function FinancialDashboard() {
  ...
  const monthly = [
    {m:"Jan",rev:42000,exp:8200,profit:33800},{m:"Feb",rev:44500,exp:7800,profit:36700},
    {m:"Mar",rev:46200,exp:9100,profit:37100},{m:"Apr",rev:47800,exp:8400,profit:39400},
    {m:"May",rev:49200,exp:8900,profit:40300},{m:"Jun",rev:51000,exp:9500,profit:41500},
    {m:"Jul",rev:52500,exp:10200,profit:42300},{m:"Aug",rev:54000,exp:9800,profit:44200},
    {m:"Sep",rev:55500,exp:10100,profit:45400},{m:"Oct",rev:56800,exp:9600,profit:47200},
    {m:"Nov",rev:58200,exp:10400,profit:47800},{m:"Dec",rev:59500,exp:11200,profit:48300},
  ];
          ...
          <motion.div initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{delay:0.3}}
            ...
            <ResponsiveContainer width="100%" height={260}>
              <LineChart data={monthly} margin={{left:-20}}>
                ...
                <Line type="monotone" dataKey="rev" stroke={G} strokeWidth={2} dot={false} activeDot={{r:4,fill:G}}/>
                <Line type="monotone" dataKey="exp" stroke="#B45309" strokeWidth={2} dot={false} activeDot={{r:4,fill:"#B45309"}}/>
                <Line type="monotone" dataKey="profit" stroke="#9FD8C0" strokeWidth={2} dot={false} activeDot={{r:4}}/>
              </LineChart>
            </ResponsiveContainer>
          </motion.div>
